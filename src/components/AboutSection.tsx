...
const FirstParagraph: React.FC = () => {
  return (
    <>
      <img src="/coding.png" alt="Coding-img" className="pr-8 pb-4 w-36 float-left" />
      <Paragraph>
      ...
      <img src="/rubiks-cube.gif" alt="Rubiks-cube-img2" className="pl-4 pt-4 w-36 float-right" />
      <br />
      <Paragraph>
